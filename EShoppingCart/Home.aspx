...
<body>
    <form id="form1" runat="server">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">
                        &times;</button>
                    <h4 class="modal-title">Welcome to our shopping website CloudStore</h4>
                </div>
                ...
                <div class="container ">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="Home.aspx"><span>
                            <img src="icons/safeIcons.png" alt="Cloud Store" height="30" /></span>Cloud Store
                        </a>
                    </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="drodown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Products<b
                                ...
                                <ul class="dropdown-menu ">
                                    ...
                                    <li role="separator" class="divider "></li>
                                    <li><a href="ManShirt.aspx">Shirts/T-Shirts</a></li>
        ...
        <div class="container center ">
            <div class="row ">
                <div class="col-lg-4">
                    <img class="img-circle " src="Images/Western_Wear.jpg" alt="thumb" width="150" height="150" />
                    <h2>Western Wear</h2>
                    <p>
                ...
                <div class="col-lg-4">
                    <img class="img-circle " src="Images/Ethnic_Wear.jpg" alt="thumb" width="150" height="150" />
                    <h2>Ethnic Wear</h2>
                    <p>
                        Featuring a 15.49-cm (6.1) all-screen Liquid Retina LCD and a glass and aluminum
                    design, the iPhone 11 is as beautiful as it gets. Also, the IP68 rating ensures
                ...
                <div class="col-lg-4">
                    <img class="img-circle " src="Images/Sarees.jpeg" alt="thumb" width="150" height="150" />
                    <h2>Sarees</h2>
                    <p>
                        Featuring a 15.49-cm (6.1) all-screen Liquid Retina LCD and a glass and aluminum
                    design, the iPhone 11 is as beautiful as it gets. Also, the IP68 rating ensures
                                ...
                                <div class="col-sm-3 col-md-3">
                                    <a href="ProductView.aspx?PID=<%# Eval("PID") %>" style="text-decoration: none;">
                                        <div class="thumbnail" style="height:350px">
                                            <img style="height:250px" src="Images/ProductImages/<%# Eval("PID") %>/<%# Eval("ImageName") %><%# Eval("Extention") %>"
                                                alt="<%# Eval("ImageName") %>" />
                                            <div class="caption">
                                                <div class="probrand">
                                                    <%# Eval ("BrandName") %>
        ...
        <footer>
            <div class="container ">
                ...
                <p>&copy;2023 &middot; <a href="Home.aspx">Home</a>&middot;<a href="#">About</a>&middot;<a href="#">Contact</a>&middot;<a href="#">Products</a> </p>
            </div>
        </footer>
        <!---Footer COntents End---->
    </form>
